...
def add(product : product_schema.Product_Base_Model , db : Session):
...
def allProducts(email : str ,db : Session):
...
def remove(product : product_schema.Product_Base_Model ,db : Session):
